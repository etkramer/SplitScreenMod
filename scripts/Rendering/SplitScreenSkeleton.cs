    ...
    class PlayerSkeletonComponent : ScriptComponent<RPawnPlayer>
    {
        ...
        public void PostBeginPlay()
        {
            ...
            var depthBiasData = new SkeletalMeshComponent.FDepthBiasData
            {
                ...
                DepthBiasCalculationType = SkeletalMeshComponent
                    .EDepthBiasCalculationType
                    .DEPTHBIASCALCULATIONTYPE_Constant,
                DepthBiasApplicationType = SkeletalMeshComponent
                    .EDepthBiasApplicationType
            ...
            meshComponent.SetSkeletalMesh(
                Game.FindObject<SkeletalMesh>("Skeletons.Mesh.Batman_Skeleton_Skin")
            );
